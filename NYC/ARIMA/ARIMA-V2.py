...
# currentFileName = 'GraphSingleStationDemandPreV4_0'
...
for i in range(0, len(testIndexList), predictLength):
    ...
    # diff
    trainTimeSeries = trainList.diff(predictLength)[predictLength:]
