...
currentFileName = 'GraphSingleStationDemandPreV11_20'
...
########################################################################################################################
trainDateRange = ['2013-07-01 00:00:00', '2014-04-23 00:00:00']
...
testDateRange = ['2014-04-23 00:00:00', '2014-07-12 00:00:00']
...
for i in range(0, len(testIndexList[:24*14]), predictLength):
    ...
    # diff
    try:
        trainTimeSeries = trainList.diff(1)[1:]
        # train the model
        ...
        realPredict = d_diff(trainList[-1], predict_data_list)
