...
# currentFileName = 'GraphSingleStationDemandPreV1_0'
argvList = sys.argv
...
n_units_pre = [n_hidden_units + addFeatureLength + 1, n_hidden_units * 2, n_hidden_units, predictLength]
...
# demandGraphMatrix = np.loadtxt(os.path.join(txtPath, 'transitionMatrix-2016-10-01-2017-01-01.txt'), delimiter=' ')
corrGraph = np.loadtxt(os.path.join(txtPath, 'correlationGraphMatrix.txt'), delimiter=' ')
...
graphMatrixRawFeed = np.array(corrGraph[allStationIDList.index(centralStationIDList[targetStationIndex])]) \
