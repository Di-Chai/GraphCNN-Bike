...
# currentFileName = 'GraphSingleStationDemandPreV10_0'
argvList = sys.argv
...
# output add dropout
encoderCell = tf.nn.rnn_cell.DropoutWrapper(encoderCell, variational_recurrent=True, #input_size=1,
                                            dtype=tf.float32,
                                            output_keep_prob=1 - dropout_pro,)
                                            # input_keep_prob=1 - dropout_pro,
                                            # state_keep_prob=1-dropout_pro)
decoderCell = tf.nn.rnn_cell.DropoutWrapper(decoderCell, variational_recurrent=True, #input_size=1,
                                            dtype=tf.float32,
                                            output_keep_prob=1 - dropout_pro,)
                                            # input_keep_prob=1 - dropout_pro,
                                            # state_keep_prob=1 - dropout_pro)
